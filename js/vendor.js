  ...
  function setTransition(duration, byController) {
    ...
    function setControlledTransition(c) {
      ...
      if (duration !== 0) {
        ...
        Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_0__["j"])(c.wrapperEl, () => {
...
function EffectCards(_ref) {
  ...
  const setTransition = duration => {
    const transformElements = swiper.slides.map(slideEl => Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_4__["l"])(slideEl));
...
function EffectCoverflow(_ref) {
  ...
  const setTransition = duration => {
    const transformElements = swiper.slides.map(slideEl => Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_3__["l"])(slideEl));
    transformElements.forEach(el => {
      el.style.transitionDuration = `${duration}ms`;
  ...
  function onTouchEnd(_ref2) {
    ...
    if (params.freeMode.momentum) {
      ...
      if (params.freeMode.momentumBounce && doBounce) {
        ...
        Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_0__["j"])(wrapperEl, () => {
...
function Scrollbar(_ref) {
  ...
  function init() {
    ...
    if (el) {
      el.classList[swiper.enabled ? 'remove' : 'add'](...Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["h"])(swiper.params.scrollbar.lockClass));
    }
  }
  function destroy() {
    const params = swiper.params.scrollbar;
    ...
    if (el) {
      el.classList.remove(...Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["h"])(swiper.isHorizontal() ? params.horizontalClass : params.verticalClass));
    }
    disableDraggable();
  }
  on('init', () => {
  ...
  const enable = () => {
    swiper.el.classList.remove(...Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["h"])(swiper.params.scrollbar.scrollbarDisabledClass));
    if (swiper.scrollbar.el) {
      swiper.scrollbar.el.classList.remove(...Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["h"])(swiper.params.scrollbar.scrollbarDisabledClass));
    }
    init();
    updateSize();
    setTranslate();
  ...
  const disable = () => {
    swiper.el.classList.add(...Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["h"])(swiper.params.scrollbar.scrollbarDisabledClass));
    if (swiper.scrollbar.el) {
      swiper.scrollbar.el.classList.add(...Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["h"])(swiper.params.scrollbar.scrollbarDisabledClass));
    }
    destroy();
  };
...
function Thumb(_ref) {
  ...
  function init() {
    ...
    } else if (Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["k"])(thumbsParams.swiper)) {
...
function Zoom(_ref) {
  ...
  function onTouchMove(e) {
    ...
    if (!image.isMoved) {
      ...
      image.startX = Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["i"])(gesture.imageWrapEl, 'x') || 0;
      image.startY = Object(_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["i"])(gesture.imageWrapEl, 'y') || 0;
...
function createShadow(suffix, slideEl, side) {
  ...
  const shadowContainer = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_0__["l"])(slideEl);
...
function effectTarget(effectParams, slideEl) {
  const transformEl = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_0__["l"])(slideEl);
...
function effectVirtualTransitionEnd(_ref) {
  ...
  if (swiper.params.virtualTranslate && duration !== 0) {
    ...
    transitionEndTarget.forEach(el => {
      Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_0__["j"])(el, () => {
...
function updateSize() {
  ...
  // Subtract paddings
  width = width - parseInt(Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["m"])(el, 'padding-left') || 0, 10) - parseInt(Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["m"])(el, 'padding-right') || 0, 10);
  height = height - parseInt(Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["m"])(el, 'padding-top') || 0, 10) - parseInt(Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["m"])(el, 'padding-bottom') || 0, 10);
...
function updateSlides() {
  ...
  for (let i = 0; i < slidesLength; i += 1) {
    ...
    if (slides[i] && Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["m"])(slide, 'display') === 'none') continue; // eslint-disable-line
...
function updateSlidesClasses() {
  ...
  if (activeSlide) {
    ...
    if (gridEnabled) {
      ...
      // Next Slide
      nextSlide = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["o"])(activeSlide, `.${params.slideClass}, swiper-slide`)[0];
      ...
      // Prev Slide
      prevSlide = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["p"])(activeSlide, `.${params.slideClass}, swiper-slide`)[0];
...
function getSwiperTranslate(axis) {
  ...
  let currentTranslate = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["i"])(wrapperEl, axis);
  ...
  if (params.cssMode) {
    ...
    if (speed === 0) {
      ...
      if (!swiper.support.smoothScroll) {
        Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["q"])({
          swiper,
...
function loopCreate(slideRealIndex) {
  ...
  if (shouldFillGroup) {
    if (params.loopAddBlankSlides) {
      ...
      Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["r"])('Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
    }
    initSlides();
    ...
    if (params.loopAddBlankSlides) {
      ...
      Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["r"])('Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
    }
    initSlides();
  } else {
    initSlides();
...
function loopFix(_temp) {
  ...
  if (slides.length < slidesPerView + loopedSlides) {
    Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["r"])('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters');
  } else if (gridEnabled && params.grid.fill === 'row') {
    Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["r"])('Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`');
  }
...
function setBreakpoint() {
  ...
  Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])(swiper.params, breakpointParams);
...
function moduleExtendParams(params, allModulesParams) {
  return function extendParams(obj) {
    ...
    if (typeof moduleParams !== 'object' || moduleParams === null) {
      Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])(allModulesParams, obj);
      return;
    }
...
class Swiper {
  constructor() {
    ...
    if (!params) params = {};
    params = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])({}, params);
    if (el && !params.el) params.el = el;
    const document = Object(_ssr_window_esm_mjs__WEBPACK_IMPORTED_MODULE_0__["g"])();
    if (params.el && typeof params.el === 'string' && document.querySelectorAll(params.el).length > 1) {
      const swipers = [];
      document.querySelectorAll(params.el).forEach(containerEl => {
        const newParams = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])({}, params, {
          el: containerEl
        });
    ...
    const swiperParams = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])({}, defaults, allModulesParams);

    // Extend defaults with passed params
    swiper.params = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])({}, swiperParams, extendedDefaults, params);
    swiper.originalParams = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])({}, swiper.params);
    swiper.passedParams = Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])({}, params);
  ...
  mount(element) {
    ...
    Object.assign(swiper, {
      ...
      mounted: true,
      // RTL
      rtl: el.dir.toLowerCase() === 'rtl' || Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["m"])(el, 'direction') === 'rtl',
      rtlTranslate: swiper.params.direction === 'horizontal' && (el.dir.toLowerCase() === 'rtl' || Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["m"])(el, 'direction') === 'rtl'),
      wrongRTL: Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["m"])(wrapperEl, 'display') === '-webkit-box'
    });
    return true;
  }
  init(el) {
  ...
  destroy(deleteInstance, cleanStyles) {
    ...
    if (deleteInstance !== false) {
      ...
      Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["u"])(swiper);
    }
    swiper.destroyed = true;
    return null;
  }
  static extendDefaults(newDefaults) {
    Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["t"])(extendedDefaults, newDefaults);
  }
...
/*!**********************************************!*\
  !*** ./node_modules/swiper/shared/utils.mjs ***!
  \**********************************************/
/*! exports provided: a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u */
/***/ (function(__webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return classesToTokens; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return getTranslate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return elementTransitionEnd; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return isObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return getSlideTransformEl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return elementStyle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return nextTick; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return elementNextAll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return elementPrevAll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return animateCSSModeScroll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return showWarning; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return setCSSProperty; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return extend; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return deleteProps; });
/* harmony import */ var _ssr_window_esm_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ssr-window.esm.mjs */ "./node_modules/swiper/shared/ssr-window.esm.mjs");
